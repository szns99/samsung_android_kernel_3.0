...
static void ft5x0x_ts_resume(struct early_suspend *handler)
{
	...
	msleep(5);
	gpio_set_value(S5PV210_GPJ3(7),1);
	msleep(200);
#if USE_POINT
	for(i=0; i<MAX_CONTACTS; i++) 
	{
...
/////////////////////////////////////////////////////////////////////////////
  ...
  {
  	gpio_direction_input(ft5x0x_ts->irq);
  	s3c_gpio_setpull(ft5x0x_ts->irq, S3C_GPIO_PULL_NONE);
  	msleep(10);
  	s3c_gpio_cfgpin(ft5x0x_ts->irq, S3C_GPIO_SFN(0xF));
